...
constructor(address payable _tellorAddress, uint256 length, uint256 breadth)  UsingTellor(_tellorAddress) public {
...
function getDimensions()  external view  returns(uint256 length , uint256 breadth) {
