...
message['Blue'] = (
  <span>
    AAVE. The galaxy's biggest DeFi lending planet where users can participate as depositors or borrowers. 
    <br />Depositors provide liquidity to the market to earn a passive income, while borrowers are able to borrow over and undercollateralized assets. 
    <br />You can learn more about this planet{' '}
...
message['Orange'] = (
  <span>
    Yearn. A yield farming planet where you can stake your cryptocurrency to earn interest as passive income.
    <br />You can learn more about this planet{' '}
...
message['Green'] = (
  <span>
    MakerDAO. This planet is the galaxy's source of Dai, the leading unbiased decentralized stablecoin.
    <br />You can learn more about this planet{' '}
...
message['Pink'] = (
  <span>
    Uniswap. This planet is the place to swap, earn, and build on the leading decentralized crypto trading protocol.
    <br />Here developers, traders, and liquidity providers participate together in a financial marketplace that is open and accessible to all.
    <br />You can learn more about this planet{' '}
...
message['White'] = (
  <span>
    ...
    <br />Here you can tokenise and get your yield upfront, and hedge your risk on APY volatility.
    <br />You can learn more about this planet{' '}
